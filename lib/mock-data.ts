...
export const projects: Project[] = [
  ...
  { id: "p7", code: "GS-2026-019", name: "Thoothukudi Harbor Dredging Tender Prep", client: "Tuticorin Port Authority", type: "Tender Work", status: "Planning", priority: "Critical", progress: 15, startDate: "2026-04-10", endDate: "2026-05-25", budget: 800000, spent: 120000, description: "Technical bid documentation, EMD and methodology for harbor dredging survey tender.", location: "Thoothukudi, Tamil Nadu", managerId: "u8", teamIds: ["u8", "u6"] },
  { id: "p8", code: "GS-2026-020", name: "Madurai Ring Road Alignment Study", client: "TNRDC", type: "DGPS Survey", status: "On Hold", priority: "Low", progress: 22, startDate: "2026-02-01", endDate: "2026-09-15", budget: 5400000, spent: 900000, description: "Alignment feasibility survey for proposed outer ring road — paused pending environmental clearance.", location: "Madurai, Tamil Nadu", managerId: "u2", teamIds: ["u2", "u5"] },
];
...
export const activity: ActivityLog[] = [
  ...
  { id: "a6", type: "team", title: "New member added", description: "Rohit Pillai joined Marine Survey", userId: "u1", timestamp: "2026-04-05T09:00:00", entityId: "u6" },
  { id: "a7", type: "project", title: "New project created", description: "Thoothukudi Harbor Dredging Tender Prep", userId: "u8", timestamp: "2026-04-10T11:25:00", entityId: "p7" },
];
